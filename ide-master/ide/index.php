...
<head>
    ...
    <meta name="description" content="Studyeze IDE is Free and open-source online code editor that allows you to write and execute code from a rich set of languages.">
    ...
    <meta property="og:title" content="Studyeze IDE - Free and open-source online code editor">
    ...
    <title>Studyeze Judge0 IDE | United Group of Institutions Prayagraj</title>
...
<body>
    <div id="site-navigation" class="ui small inverted menu">
        <div id="site-header" class="header item">
            <a href="/">
                <img id="site-icon" src="./images/logo_transparent.png">
                <h2>Studyeze</h2>
            </a>
        </div>
        <div class="left menu">
    ...
    <div id="site-footer">
        ...
        <span>© 2019-2020 <a href="https://www.studyeze.in">Studyeze.in</a> · Powered by <a href="https://api.judge0.com">Judge0</a> </span>
